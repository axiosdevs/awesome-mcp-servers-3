...
- **[AgentPump](https://github.com/axiosdevs/agentpump-mcp)** - Give your AI agent a Solana wallet to launch & trade tokens on AgentPump, a pump.fun-style bonding-curve launchpad on Solana mainnet (1% fee, auto-graduates to Raydium; can also trade graduated tokens on Raydium).
